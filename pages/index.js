...
background: ${(props) =>
props.active
? "linear-gradient(90deg, #ff6c52 0%, #64ffda 100%)"
: "#232336"};
...
cursor: pointer;
box-shadow: ${(props) =>
props.active ? "0 1px 10px #12e6d7aa" : "0 1px 7px #0001"};
...
// List of all your mp3s (update if you rename any file)
const files = [
"240.mp3",
...
<Wrapper>
<Title>
Epic Tech AI <span style={{ color: "#ff6c52" }}>MP3 Player</span>
</Title>
<FileList>
{files.map((name) => (
...
<Credits>
If the direct mp3 link fails, the file is missing or your deploy isn't synced.<br />
Rename files for maximum compatibility: use only letters, numbers, underscores, or dashes.
</Credits>
</Wrapper>
);
}
